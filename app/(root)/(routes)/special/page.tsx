...
const ClassesTable = () => {
  ...
  const validClasses =
    teacherClasses.filter(Boolean).slice(0, 3) ||
    studentClasses.filter(Boolean).slice(0, 3);
                  ...
                  <div className="mt-5 flex flex-wrap justify-center">
                    {teacherClasses.map((classItem) => (
                      <div
                        ...
                        className="w-full md:w-1/2 lg:w-1/3 xl:w-1/3 2xl:w-1/4 px-2"
                      >
                            ...
                            <Carousel className="md:relative w-full h-full">
                              <CarouselContent className="flex mx-auto md:justify-center h-full">
                                {validClasses.map((classItem) => (
                                  ...
                                  >
                                    <div className="w-[90%] sm:w-full md:w-[100%] xl:w-[90%] transition-all hover:shadow-lg border-2 p-10 rounded-xl bg-white shadow-md flex flex-col items-center">
                                      {/* Class Icon or Image */}
                                      <ClassImage
                                      ...
                                      <Button
                                        onClick={() =>
                                          handleOnClick(classItem.classId)
                                        }
                                          ...
                                          <AlertDialogContent>
                                            ...
                                            <AlertDialogFooter>
                                              ...
                                              <AlertDialogAction
                                                ...
                                                className="hover:translate-y-[2px] z-100 bg-gray-200 hover:bg-gray-200 rounded-2xl w-fit flex items-center gap-x-2 text-black transition-all duration-100"
                                              >
                                                Delete Class{" "}
                                                <Trash className="w-4 h-4" />
                                              </AlertDialogAction>
